...
最终结果如下图所示：
<img src="{{'/assets/img/2018-2-23-创建事务菜单项6.png' | prepend: site.baseurl }}" alt=""><br>
...
1。如果是手动启动Ebaas，终止方法：按“Ctl+C”，见下图：<br>
<img src="{{'/assets/img/2018-2-23-重启Ebaas服务器1.png' | prepend: site.baseurl }}" alt=""><br>
2。如果是系统自动启动Ebaas服务，终止方法：Windows任务管理器，选项卡里选中“EbaasServer.exe”进程，单击“结束进程（E）”按钮，见下图：<br>
<img src="{{'/assets/img/2018-2-23-重启Ebaas服务器2.png' | prepend: site.baseurl }}" alt=""><br>
