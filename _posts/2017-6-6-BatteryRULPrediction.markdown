...
In this post, I would like to present a case where I apply deep learning for a business problems. The particular application of deep learning in this post is using LSTM, which is a type of recurrent neural network, to predict Li-ion battery remaining useful life(RUL).
