...
The Issue Tracking Application you built in the tutorial of "Build your first application with Ebaas" is a simple business application which you can enhance with a workflow to model the process of resolving an issue in an organization. You will build a simple state machine workflow using Ebaas WorkflowStudio to track the progress of the issues.
